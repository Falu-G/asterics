        ...
        <div className="customerContainer">
            ...
            <div className={sidebar ? "maindashboardContainerDashboard" : "maindashboardContainerDashboardClosed"}>
                ...
                <Modal isOpen={openModalEmail}
                    ...
                    <AddCustomer openModal = {openModalEmail} setOpenModal = {() => setOpenModalEmail(() => openModalEmail ? false : true)}/>
                ...
                <div style={{
                    ...
                    <div className="customerWrapper">
                        <div> <button className="btnAddCustomer"
                            onClick={() => setOpenModalEmail(() => openModalEmail ? false : true)}>AddCustomer</button></div>
