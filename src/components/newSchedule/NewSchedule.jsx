            ...
            <form className="ns-Scheduler-input">
                <div className="ns-Scheduler-house">
                    <input type="text" name="name" placeholder= { 
                        (messageType === "SMS") || (messageType === "Email") ? "PhoneNumber": "Phone Number or Email"} disabled />
                    <textArea type="messages" name="name" />
                
                        <div style={{width:"100%"}}>
                        <input type="submit" name="Schedule"
                            className={(messageType === "SMS") || (messageType === "Email")  ? "ns-scheduler-submit ns-Enabled": "ns-scheduler-submit" }
                        />
